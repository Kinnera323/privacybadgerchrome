...
function loadOptions()
{
  ...
  $("#activate_devsettings_btn").click(deactive_devsettings);
  $("#deactivate_devsettings_btn").click(active_devsettings);
  if(!Utils.isConsoleLoggingEnabled()) {
    $("#activate_devsettings_btn").hide();
    $("#deactivate_devsettings_btn").show();
  }
...
function active_devsettings(){
  $("#activate_devsettings_btn").toggle();
  $("#deactivate_devsettings_btn").toggle();
  localStorage.ConsoleLoggingEnabled = "true";
}

function deactive_devsettings(){
  $("#activate_devsettings_btn").toggle();
  $("#deactivate_devsettings_btn").toggle();
...
function _badgerStatusTitle(action, origin){
  ...
  return prefix + statusMap[action] + origin ;
}
...
function refreshFilterPage() {
  ...
  Utils.ConsoleLogging(["Done refreshing options page"]);
}
...
function syncSettingsDict(settingsDict) {
  ...
  Utils.ConsoleLogging(["Finished syncing. Now refreshing options page."]);
...
window.addEventListener('unload', function() {
  Utils.ConsoleLogging(["Starting to unload options page"]);
  syncUISelections();
  Utils.ConsoleLogging(["unloaded options page"]);
});
